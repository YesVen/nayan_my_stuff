 ...
 * and then continue same procedure for all elements before pivot and after pivot
 * worst/Average case: O(nlogn) but this is inplace sorting as no additional arrays need to create
 *  
 * */
